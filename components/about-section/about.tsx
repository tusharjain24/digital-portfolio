...
import "./about.css";
import { RESUME_URL, USER_DETAILS } from "@/constants/project.constants";
        ...
        <div className="w-[100%] sm:max-w-[50%] mx-auto">
          <div className="about__info justify-center text-gray-700 dark:text-white/75">
            <Link
              ...
              <span className="about__subtitle">{USER_DETAILS.WorkExperience}</span>
            </Link>
            <Link
              href="#projects"
              replace
              ...
              <span className="about__subtitle">{USER_DETAILS.CompletedProjects}</span>
            </Link>
            <Link
              href="#contact"
              replace
